...
def leer_camion(nombre_archivo):
	...
	lo lee y arma una lista de diccionarios
	Luego arma camion que es una lista de instancias de objetos de la clase lote
	'''
	import fileparse 
	with open(nombre_archivo) as f:
		camion_dicts=fileparse.parse_csv(f, select = ['nombre', 'cajones', 'precio'], types = [str, int, float])
		camion = [lote.Lote(d['nombre'], d['cajones'], d['precio']) for d in camion_dicts]  #uso los atributos de los objetos clase lote
	return camion
